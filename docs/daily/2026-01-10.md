...
### CPU Utilization (Revisited in Jan 11 analysis)
- 8 envs at 82-95% CPU initially seemed okay
- **Post-training discovery**: This was too aggressive, caused thermal throttling
- Training took 10.2 hours instead of expected 4-5 hours
- Phase 5 will reduce to 4 envs for better stability
