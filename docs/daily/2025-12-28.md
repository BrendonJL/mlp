...
- [x] Installed PostgreSQL server and client tools via dnf ✅ 2025-12-28
- [x] Initialized PostgreSQL database cluster and started service ✅ 2025-12-28
- [x] Installed psycopg2-binary Python adapter via Poetry ✅ 2025-12-28
- [x] Created PostgreSQL user `mario_rl_user` with password ✅ 2025-12-28
- [x] Created database `mario_rl_db` owned by project user ✅ 2025-12-28
- [x] Configured PostgreSQL authentication (pg_hba.conf) for password auth ✅ 2025-12-28
- [x] Successfully connected to database from Python ✅ 2025-12-28
- [x] Executed first SQL query (SELECT version()) ✅ 2025-12-28
- [x] Configured Obsidian Daily Notes plugin with Templater ✅ 2025-12-28
...
- [x] Design database schema for experiment tracking 📅 2025-12-29 ✅ 2025-12-29
- [x] Create tables for experiments, hyperparameters, and metrics 📅 2025-12-29 ✅ 2025-12-29
...
# Changed: ident/peer → md5 for local connections
