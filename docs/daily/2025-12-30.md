...
- [x] Debugged and resolved Python version conflicts ✅ 2025-12-30
- [x] Discovered Poetry `env use` bug with Python 3.14 system default ✅ 2025-12-30
- [x] Manually created Python 3.11 virtual environment ✅ 2025-12-30
- [x] Fixed NumPy 2.0 compatibility issue with gym-super-mario-bros ✅ 2025-12-30
- [x] Successfully tested Mario environment (observation and action spaces verified) ✅ 2025-12-30
- [x] Reinstalled pre-commit hooks for new venv ✅ 2025-12-30
- [x] **Completed first Phase 2 task: Install and test gym-super-mario-bros environment** ✅ 2025-12-30
...
- **When abstractions fail, go deeper**: Poetry wrapper buggy → use Python's venv module directly
- **Systematic debugging**: Verify assumptions → check config → trace execution → find root cause
...
- Traced venv symlinks: `.venv/bin/python -> /usr/bin/python3` → 3.14
...
.venv/bin/python --version  # Verify: 3.11.14 ✅
readlink -f .venv/bin/python  # Points to /usr/bin/python3.11 ✅
